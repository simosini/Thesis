...
Despite being a very simple model, this network showed a better performances on the test set compared to other deeper (that is with more hidden layers) or bigger (i.e with a greater number of nodes) models. Check chapter \ref{Chapter5} for further details on the results.
